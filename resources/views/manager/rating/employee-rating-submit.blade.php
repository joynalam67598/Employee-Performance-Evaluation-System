            ...
            <div class="row">
                <div class="col-sm-12">
                   ...
                   @else
                        ...
                        <div class="card-body">
                            {{ Form::open(['route'=>'submit-employee-rating','method'=>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data']) }}
                            ...
                            <div class="form-group row">
                                {{Form::label('employee_id','Employee Name',['class'=>'col-sm-3'])}}
                                <div class="col-sm-9">
                                    {{Form::text('employee_name',$employee->employee_official_id.' , '.$employee->first_name.'  '.$employee->last_name,['class'=>'form-control','readonly'])}}
