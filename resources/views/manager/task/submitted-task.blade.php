                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header text-center">
                            <h4 class="text-info">Submitted Tasks Table</h4>
                        </div>
                        <div class="card-body ">
                                    ...
                                    @foreach($tasks as $task)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a  href="{{route('show-task-report',['id'=>$task->id])}}" class="btn btn-dark btn-xs" title="View Daily Update">
                                                    <span class="fa fa-newspaper"></span>
                                                </a>
                                                <a  href="{{route('manager-give-rating',['id'=>$task->id])}}" class="btn btn-outline-warning btn-xs" title="Give Rating">
